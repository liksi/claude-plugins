...
- **Pas d'em dashes (—)** : remplacer systématiquement les em dashes par une alternative naturelle selon le contexte — virgule, deux-points, parenthèses, ou reformulation de la phrase.
